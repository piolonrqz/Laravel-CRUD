...
@section('content')
    ...
    <div class="flex justify-center mt-4">
        <div class="text-center p-8 bg-neutral-200 shadow-lg rounded-lg w-4/5 max-w-lg">
            <h1 class="text-4xl font-bold text-green-800 mb-4">Add New Intern</h1>
            <form action="{{ route('intern.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="institution" id="institution" class="w-full p-2 border rounded" required>
                </div>
                <div class="mb-4">
                    <label for="career_path" class="block text-lg font-bold text-gray-700">Career Path</label>
                    <input type="text" name="career_path" id="career_path" class="w-full p-2 border rounded" required>
                </div>
                <button type="submit" class="bg-green-800 text-white py-2 px-6 rounded hover:bg-green-600">Submit</button>
            </form>
        </div>
    </div>
@endsection
